...
6. Submit the URL to your repo and the saved image to the Gauchospace Dropbox.
...
For example, there are `r nrow(big_cities)` cities with a population greater than `r formatC(threshold, format="d", big.mark=",")`.
...
big_cities %>% 
  ...
  labs(title = "USA Cities Population Stats",
       subtitle = paste("Cities bigger than:", 
                        ...
                        "people"),
       caption = paste("Made by:", rmarkdown::metadata$author, "- Geography 13"),
       x="",
       y = "") + 
  theme_bw()
```
